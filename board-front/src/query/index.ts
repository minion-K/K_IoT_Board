//! React Query
/* 
  서버로 가져오는 데이터(fetch)를 자동으로 캐싱해주고
  로딩/에러 상태 관리, 새로고침할 필요없이 자동으로 최신화해주는
  데이터 관리 라이브러리
*/
...
//? Zustand와의 차이점
// React Query = 서버 상태(Server State) 관리 라이브러리
